...
async def call_firecrawl_extractor(links, request_id=None):
    ...
    async with firecrawl_semaphore:
        ...
        payload = {
            "urls": resolved_links,
            "prompt": (
                  "Extract the main product price and the direct product page URL from each input link and include the website name. If the URL is a search results page, extract information only from the first listed product."
